      ...
      <div className={m.wrapper}>
        <div className={m.element}>
          <div className={m.elementWrapper}>
            ...
            <p className={m.smallNumbText}>
              которые хотят найти крутых<br /> специалистов
            </p>
          </div>
        </div>
        <div className={m.element}>
          <div className={m.elementWrapper}>
            ...
            <p className={m.smallNumbText}>
              которые хотят увеличить поток<br /> звонков новыми интсрументами
            </p>
          </div>
        </div>
        <div className={m.element}>
          <div className={m.elementWrapper}>
            ...
            <p className={m.smallNumbText}>
              которые хотят развивать свой<br /> блог и вырваться вперед
            </p>
          </div>
        </div>
        <div className={m.element}>
          <div className={m.elementWrapper}>
            ...
            <p className={m.numbText}>
              Для специалистов, которые<br /> хотят узнать свежие функции<br /> и кейсы для
              продвижения
            </p>
          </div>
        </div>
        <div className={m.element}>
          <div className={m.elementWrapper}>
            ...
            <p className={m.numbText}>
              Для студентов ищуших себя<br /> и всем, кто считает, что за<br /> IT будущее
            </p>
          </div>
        </div>
        <div className={m.element}>
          <div className={m.elementWrapper}>
            ...
            <p className={m.numbText}>
              Для тех, кто хочет провести<br /> целый день в digital - тусовке<br /> общаясь
              на одном языке
            </p>
          </div>
        </div>
