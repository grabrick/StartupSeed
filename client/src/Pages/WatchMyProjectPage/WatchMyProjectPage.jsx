...
import './WatchMyProjectPage.css'
import axios from "axios";
import { useDispatch, useSelector } from "react-redux";
import { getCurrentProject, getFavorite } from "../../redux/slices/currentProjectSlice";
import WatchMyProject from "../../components/MyProject/WatchMyProject/WatchMyProject";

function WatchMyProjectPage({isAdmin}) {
  const currentLink = window.location.href;
  const findProjectID = currentLink.toString().slice(35, 62);
  ...
  return (
    <div className="content">
      <div className="wrapper">
        <WatchMyProject isAdmin={isAdmin} items={currentProject} projectId={findProjectID} />
      </div>
      <Footer />
    </div>
  );
...
export default WatchMyProjectPage;