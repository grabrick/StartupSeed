  ...
  return (
    <div className={m.container}>
      <div className={m.titleWrapp}>
        <p className={m.title}>
          <span className={m.span}>Startup seed</span> - твой быстрый каръерный
          эсколатор
        </p>
      ...
      <div className={m.wrapper}>
        <div className={m.blockWrapp}>
          ...
          <ol className={m.numbWrapp}>
            <li value="1" className={m.numbText}>
              Зарегестрируйся на<br /> платформе Укажи свои навыки
            </li>
        ...
        <div className={m.blockWrapp}>
          ...
          <ol className={m.numbWrapp}>
            ...
            <li value="2" className={m.numbText}>
              Выбери свой проект и<br /> направление по которому<br /> хочешь развиваться
            </li>
          </ol>
        </div>
        <div className={m.blockWrapp}>
          ...
          <ol className={m.numbWrapp}>
            ...
            <li value="2" className={m.numbText}>
              Раскрой свой потенциал и<br /> докажи всем на что ты<br /> способен
            </li>
          </ol>
        </div>
        <div className={m.blockWrapp}>
